...
abstract class AbstractController extends ActionController
{
     ...
     * User ratings
     */
    const RATING_USEFUL = 1;
    const RATING_NOT_USEFUL = 2;
    const RATING_UNDECIDED = 3;
    ...
    {
        $thirdPartyParameters = array();
        $thirdPartyParametersFilter = array(
    ...
    protected function redirectWith3rdPartyParameters($actionName, array $pluginArguments = null, array $thirdPartyParameters = null, $section = '')
    {
        if (!$this->request instanceof Request) {
            throw new UnsupportedRequestTypeException('redirectWith3rdPartyParameters() only supports web requests.', 1362411546);
        }
